 ...
 Pet.fromMap(Map<String, dynamic> mapa) {
  ...
  update() {
    if (_state != 'dead') {
      ...
      print("O tempo de atualizar foi = $deltaTime");
      // taxas estão relacionadas ao estado atual do Pet
      var hungerRate = 4, healthRate = 4, happyRate = 4, dirtyRate = 4, sleepRate = 4;
      ...
      if (deltaTime != 0) {
        ...
        _hunger -= (hungerRate * rnd.nextDouble() * heightHunger * 0.3 ).toInt();
        _health -= (healthRate * rnd.nextDouble() * heightHealth * 0.3).toInt();
        _happy -= (happyRate * rnd.nextDouble() * heightHappy * 0.3).toInt();
        _dirty -= (dirtyRate * rnd.nextDouble() * heightDirty * 0.3).toInt();
        _sleep -= (sleepRate * rnd.nextDouble() * heightSleep * 0.3).toInt();
      }
